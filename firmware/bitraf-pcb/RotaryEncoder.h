...
template<int _PIN_ENC1, int _PIN_ENC2, int _PIN_BTN, typename value_t = uint16_t>
class RotaryEncoderDecoder {
  public:
    static const int PIN_ENC1 = _PIN_ENC1;
    static const int PIN_ENC2 = _PIN_ENC2;
    static const int PIN_BTN = _PIN_BTN;
